...
export const EmergencyOutingPage: React.FC = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      await API.post('/student/outings/emergency', form);
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto pb-10">
      <div className="flex items-center bg-red-50 p-4 rounded-xl shadow-sm border border-red-200 gap-4">
         ...
         <h1 className="text-xl font-bold text-red-800">Apply Emergency Outing</h1>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-[var(--color-border-gray)] p-6 space-y-6 border-t-4 border-t-red-500">
         <h3 className="text-[16px] font-bold text-red-700 uppercase tracking-wider mb-2 border-b pb-3">
           Emergency Details
         </h3>
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="col-span-1 md:col-span-2 space-y-2">
               ...
               <textarea 
                 ...
                 placeholder="Please clearly describe the emergency..." 
                 rows={3} 
               />
            </div>
      ...
      <Modal isOpen={isConfirmOpen} onClose={() => !submitting && setIsConfirmOpen(false)} title="Confirm Emergency Outing">
         <div className="space-y-4 w-full sm:w-[400px]">
           <p className="text-sm text-gray-600 mb-4">You are about to submit an EMERGENCY request. This will alert caretakers.</p>
